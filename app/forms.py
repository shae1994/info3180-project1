...
class CreateProperty(FlaskForm):
    ...
    no_of_bedrooms = StringField('No. of Bedrooms', validators=[DataRequired()])
    no_of_bathrooms = StringField('No. of Bathrooms', validators=[DataRequired()])
    prices = StringField('Price', validators=[DataRequired()])
    types = SelectField('Property Types', choices=[('Single-Family House', 'Single-Family House'), ('Multi-Family House', 'Multi-Family House'), ('Apartment', 'Apartment'), ('Town-House', 'Town-House'), ('Mansion', 'Mansion'), ('Villa', 'Villa'), ('Condo', 'Condo'), ('Co-operative', 'Co-operative')],validators=[InputRequired()])
